...
The public request contract contains only information a Customer can reasonably provide. It does not contain an internal business area, destination team, analyst discipline or dissemination recipient. The authenticated requester is the eventual Customer recipient, while JIOC and later routing users make internal routing choices through the existing human-led workflow.
