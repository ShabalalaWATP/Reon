...
| DOD-01 | Source control has an initial reviewed baseline and an approved private remote or a signed local-only exception | Git log, remote record and decision entry | OPEN |
