...
- human-led routing through CRIOC, JOCK, ACSA-B Ops, SSG Team and selectable
  sibling branches;
...
| CRIOC representative | PENDING | PENDING | PENDING | PENDING |
| JOCK or sibling command representative | PENDING | PENDING | PENDING | PENDING |
| ACSA-B Ops or sibling Ops representative | PENDING | PENDING | PENDING | PENDING |
