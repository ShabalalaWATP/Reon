...
from demo_portfolio_client import (  # noqa: E402
    Actor,
    claim,
    complete,
    destination,
...
class JourneyActors:
    ...
    quality: Actor
    release: Actor  # a different QC Manager: separation of duty hides release
    # work from whoever approved the quality review.
