...
export const teamApi = {
  ...
  workspaceRecords: (teamId: string) =>
    apiRequest<WorkspaceRecordList>(`/team-workspaces/${encodeURIComponent(teamId)}/records`),
  createWorkspaceRecord: (teamId: string, input: WorkspaceRecordInput, csrfToken: string) =>
    apiRequest<WorkspaceRecordList>(`/team-workspaces/${encodeURIComponent(teamId)}/records`, {
      body: input,
      csrfToken,
      method: "POST",
  ...
  teamWorkspace: (teamId: string) =>
    apiRequest<TeamWorkspaceOverview>(`/team-workspaces/${encodeURIComponent(teamId)}`),
  teamPeople: (teamId: string) =>
    apiRequest<TeamPeople>(`/team-workspaces/${encodeURIComponent(teamId)}/people`),
  ...
  teamActivity: (teamId: string) =>
    apiRequest<TeamActivityList>(`/team-workspaces/${encodeURIComponent(teamId)}/activity`),
  addTeamMember: (teamId: string, input: AddMemberInput, csrfToken: string) =>
    apiRequest<TeamPeople>(`/team-workspaces/${encodeURIComponent(teamId)}/memberships`, {
      body: input,
      csrfToken,
      method: "POST",
    }),
  transferTeamMember: (teamId: string, input: TransferMemberInput, csrfToken: string) =>
    apiRequest<TeamPeople>(`/team-workspaces/${encodeURIComponent(teamId)}/transfers`, {
      body: input,
      csrfToken,
      method: "POST",
    }),
