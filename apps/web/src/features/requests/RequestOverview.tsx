  ...
  return (
    <section className="detail-section" aria-labelledby="overview-title">
      ...
      <div className="narrative-list">
        ...
        <article><h3>Question to answer</h3><p>{request.questionToAnswer}</p></article>
        <article><h3>Subject area or location</h3><p>{request.subjectAreaOrLocation}</p></article>
        <article><h3>Activity or decision supported</h3><p>{request.supportedActivityOrDecision}</p></article>
        ...
        <article><h3>Constraints or caveats</h3><p>{request.constraintsOrCaveats}</p></article>
        <article><h3>Supporting information</h3><p>{request.supportingInformation}</p></article>
