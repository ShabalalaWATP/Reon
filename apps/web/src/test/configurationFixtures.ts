...
export const configurationVersion: ConfigurationVersion = {
  ...
  workflowTemplate: {
    ...
    taskLabels: {
      intake_review: "CRIOC review",
      requester_response: "Customer response",
      coordination_review: "Command review",
      on_hold: "On hold",
      allocation_review: "Ops allocation",
      delivery_planning: "Delivery planning",
      delivery_work: "Product development",
  ...
  changes: [
    {
      ...
      unitId: "unit-team",
      code: "PINE_TEAM",
      message: "Pine Team will be added beneath Northern Ops Group.",
