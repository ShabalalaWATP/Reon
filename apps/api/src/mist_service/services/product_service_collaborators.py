...
from mist_service.product_ports import ExternalLinkPolicy, ProductAccessAudit
...
class ProductAccessRecorder:
    ...
    async def record(
        ...
        from mist_service.product_security import normalise_product_correlation_id
