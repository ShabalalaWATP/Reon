...
from istari_service.board_policy import authorise_board_manager, require
from istari_service.board_ports import BoardRepositoryPort, WorkPackageRecord
...
from istari_service.schemas.board import WorkPackageCommand
